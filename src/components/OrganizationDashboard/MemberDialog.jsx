                    ...
                    <form onSubmit={(e) => e.preventDefault()}>
                      <div className="flex flex-col relative grow">
                        <input
                          ...
                          className={clsx(
                            "peer px-3 py-2 mt-2 rounded-md w-full border text-sm border-slate-300 bg-transparent focus:outline-none focus:border-emerald-500 focus:ring-1 focus:ring-emerald-500 focus:placeholder-gray-400 placeholder-transparent",
